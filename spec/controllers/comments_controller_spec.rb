  ...
  describe 'POST#create' do
    ...
    context 'with valid attributes' do
      ...
      it 'saves a new comment in the database' do
        expect { post :create, params: { comment: attributes_for(:comment), question_id: question.id }, format: :json }.to change(question.comments, :count).by(1)
      end
    ...
    context 'with invalid attributes' do
      it 'does not save the answer' do
        expect { post :create, params: { comment: attributes_for(:comment, :invalid), question_id: question.id }, format: :json }.to_not change(question.comments, :count)
      end
